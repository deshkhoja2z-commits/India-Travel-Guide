...
document.addEventListener("DOMContentLoaded", function () {
    ...
    currentButtons.forEach(function (button) {
        ...
        button.addEventListener("click", function (event) {
            ...
            /*
              Google Maps automatically asks for
    ...
    /* ==================================================
       MAP BUTTONS
       Normal Google Maps links already work through HTML.
       This section only makes sure external links
       open correctly.
    ================================================== */
    ...
    internalLinks.forEach(function (link) {
        ...
        link.addEventListener("click", function (event) {
            ...
            /*
              Current buttons have href="#",
              so they are handled separately above.
            */

            if (
                !targetID ||
                targetID === "#" ||
                link.hasAttribute("data-current-route")
            ) {
                return;
            }
