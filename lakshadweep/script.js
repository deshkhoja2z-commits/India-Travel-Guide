...
document.addEventListener(
        ...
        */
        ...
        card.addEventListener(
            ...
            function (event) {
                ...
                /*
                   Actual link/button पर
                   click हुआ है तो normal
                   action होने दें।
                */
    ...
    /* =====================================================
       21. GENERIC CARD FALLBACK

       अगर किसी future HTML card में
       .card class है और उसमें एक
       main link है तो पूरा card
       clickable होगा।
    ===================================================== */
    ...
    ===================================================== */
          ...
          /* =====================================================
       22. PARTNER REGISTRATION FORM

       Compatible with:
       lakshadweep-reg.html
    ===================================================== */
...
--------------------------------
DESH KHOJ A2Z
Lakshadweep Partner Registration`;
                ...
                const emailSubject =
                    "DESH KHOJ A2Z - Lakshadweep Business Partner Registration";
    ...
    /* =====================================================
       23. SIMPLE PARTNER SERVICE BUTTONS
...
DESH KHOJ A2Z`;
                        ...
                        const emailSubject =
                            "DESH KHOJ A2Z - Lakshadweep Partner Registration - " +
                            service;
...
process and required details.`;
    ...
    /* =====================================================
       25. SERVICE BUTTON TOUCH FEEDBACK
    ===================================================== */
